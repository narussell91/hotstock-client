<template>
  <p>
    Title: Hot Stock - Privacy Subtitle: Privacy Navigation links: Copy/text for
    page: Privacy Policy Last updated: March 26, 2022 This Privacy Policy
    describes Our policies and procedures on the collection, use and disclosure
    of Your information when You use the Service and tells You about Your
    privacy rights and how the law protects You. We use Your Personal data to
    ...
    in plural. Definitions For the purposes of this Privacy Policy: Account
    means a unique account created for You to access our Service or parts of our
    Service. Company refers to Hot Stock. Cookies are small files that are
    ...
    many uses. Country refers to: New York, United States Device means any
    ...
    assist the Company in analyzing how the Service is used. Third-party Social
    Media Service refers to any website or any social network website through
    which a User can log in or create an account to use the Service. Usage Data
    ...
    of a page visit). Website refers to Hot Stock, accessible from
    <a href="www.hotstock.com" rel="external nofollow noopener" target="_blank"
      >www.hotstock.com</a
    >
    ...
    the Service, as applicable. Collecting and Using Your Personal Data Types of
    ...
    Address, State, Province, ZIP/Postal code, City Usage Data Usage Data Usage
    ...
    use, Your mobile device unique ID, the IP address of Your mobile device,
    ...
    You access the Service by or through a mobile device. Tracking Technologies
    and Cookies We use Cookies and similar tracking technologies to track the
    ...
    setting so that it will refuse Cookies, our Service may use Cookies. Flash
    ...
    certain section and verifying system and server integrity). Persistent
    ...
    below: Necessary / Essential Cookies Type: Session Cookies Administered by:
    ...
    Administered by: Us Purpose: These Cookies identify if users have accepted
    the use of cookies on the Website. Functionality Cookies Type: Persistent
    ...
    details or language preference. The purpose of these Cookies is to provide
    ...
    Policy or the Cookies section of our Privacy Policy. Use of Your Personal
    Data The Company may use Personal Data for the following purposes: To
    ...
    have purchased or of any other contract with Us through the Service. To
    ...
    security updates, when necessary or reasonable for their implementation. To
    ...
    receive such information. To manage Your requests: To attend and manage Your
    ...
    among the assets transferred. For other purposes: We may use Your
    ...
    situations: With Service Providers: We may share Your personal information
    with Service Providers to monitor and analyze the use of our Service, to
    contact You. For business transfers: We may share or transfer Your personal
    ...
    business to another company. With Affiliates: We may share Your information
    ...
    that are under common control with Us. With business partners: We may share
    ...
    period of time, except when this data is used to strengthen the security or
    to improve the functionality of Our Service, or We are legally obligated to
    ...
    may differ than those from Your jurisdiction. Your consent to this Privacy
    ...
    and becomes subject to a different Privacy Policy. Law enforcement Under
    ...
    defend the rights or property of the Company Prevent or investigate possible
    wrongdoing in connection with the Service Protect the personal safety of
    Users of the Service or the public Protect against legal liability Security
    of Your Personal Data The security of Your Personal Data is important to Us,
    ...
    absolute security. Children's Privacy Our Service does not address anyone
    ...
    requires consent from a parent, We may require Your parent's consent before
    We collect and use that information. Links to Other Websites Our Service may
    contain links to other websites that are not operated by Us. If You click on
    ...
    Privacy Policy We may update Our Privacy Policy from time to time. We will
    notify You of any changes by posting the new Privacy Policy on this page. We
    will let You know via email and/or a prominent notice on Our Service, prior
    ...
    Privacy Policy periodically for any changes. Changes to this Privacy Policy
    are effective when they are posted on this page. Contact Us If you have any
    questions about this Privacy Policy, You can contact us: By email:
    contact@hotstock.com
  </p>
</template>
